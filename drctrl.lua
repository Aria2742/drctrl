...
function update()
  while true do 
    ...
    local satPercent
    satPercent = math.ceil(ri.energySaturation / ri.maxEnergySaturation * 100)
    ...
    fieldPercent = math.ceil(ri.fieldStrength / ri.maxFieldStrength * 100)
    ...
    -- out of fuel, kill it
    if fuelPercent <= lowestFuelPercent then
      reactor.stopReactor()
      action = "Fuel < " ..lowestFieldPercent.."%"
    end
